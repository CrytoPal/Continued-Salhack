...
public class AutoMount extends Module {
    ...
    public final Value<Boolean> SkeletonHorses = new Value<>("SkeletonHorses", new String[] {"SkeletonHorse"}, "Mounts SkeletonHorses", true);
    public final Value<Boolean> Donkeys = new Value<>("Donkeys", new String[] {"Donkey"}, "Mounts Donkeys", true);
    public final Value<Boolean> Pigs = new Value<>("Pigs", new String[] {"Pig"}, "Mounts Pigs", true);
    public final Value<Boolean> Llamas = new Value<>("Llamas", new String[] {"Llama"}, "Mounts Llamas", true);
    public final Value<Boolean> Striders = new Value<>("Striders", new String[] {"Strider"}, "Mounts Striders", true);
    public final Value<Integer> Range = new Value<>("Range", new String[] {"R"}, "Range to search for mountable entities", 4, 0, 10, 1);
